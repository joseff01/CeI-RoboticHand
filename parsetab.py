...
_lr_productions = [
  ...
  ('algorithm -> algorithm algorithm_line','algorithm',2,'p_lines','compiler.py',152),
  ('algorithm -> empty','algorithm',1,'p_lines','compiler.py',153),
  ('algorithm_line -> expression PyC','algorithm_line',2,'p_first_section','compiler.py',160),
  ('algorithm_line -> var_assign PyC','algorithm_line',2,'p_first_section','compiler.py',161),
  ('algorithm_line -> for_loop PyC','algorithm_line',2,'p_first_section','compiler.py',162),
  ('algorithm_line -> while_loop PyC','algorithm_line',2,'p_first_section','compiler.py',163),
  ('algorithm_line -> if_else','algorithm_line',1,'p_first_section','compiler.py',164),
  ('operator -> PLUS','operator',1,'p_operator','compiler.py',171),
  ('operator -> MINUS','operator',1,'p_operator','compiler.py',172),
  ('operator -> INT_DIV','operator',1,'p_operator','compiler.py',173),
  ('operator -> DIVIDE','operator',1,'p_operator','compiler.py',174),
  ('operator -> EXP','operator',1,'p_operator','compiler.py',175),
  ('operator -> MULTIPLY','operator',1,'p_operator','compiler.py',176),
  ('expression -> OPERA OPEN_P operator COMMA expression COMMA expression CLOSE_P','expression',8,'p_expression_opera','compiler.py',182),
  ('bool_operator -> EQUALS_EQUALS','bool_operator',1,'p_bool_operator','compiler.py',188),
  ('bool_operator -> DISTINCT','bool_operator',1,'p_bool_operator','compiler.py',189),
  ('bool_operator -> LESS_EQUAL','bool_operator',1,'p_bool_operator','compiler.py',190),
  ('bool_operator -> MORE_EQUAL','bool_operator',1,'p_bool_operator','compiler.py',191),
  ('bool_operator -> MORE_THAN','bool_operator',1,'p_bool_operator','compiler.py',192),
  ('bool_operator -> LESS_THAN','bool_operator',1,'p_bool_operator','compiler.py',193),
  ('expression -> expression bool_operator expression','expression',3,'p_expression_bool','compiler.py',200),
  ('var_assign -> LET VARIABLE EQUALS expression','var_assign',4,'p_var_assign','compiler.py',206),
  ('for_loop -> FOR INT IN INT dDOT INT SB1 algorithm SB2','for_loop',9,'p_for_loop','compiler.py',214),
  ('for_loop -> FOR VARIABLE IN INT dDOT INT SB1 algorithm SB2','for_loop',9,'p_for_loop','compiler.py',215),
  ('for_loop -> FOR INT IN INT dDOT_E INT SB1 algorithm SB2','for_loop',9,'p_for_loop','compiler.py',216),
  ('for_loop -> FOR VARIABLE IN INT dDOT_E INT SB1 algorithm SB2','for_loop',9,'p_for_loop','compiler.py',217),
  ('if_else -> IF expression SB1 algorithm SB2','if_else',5,'p_if_else','compiler.py',224),
  ('while_loop -> WHILE OPEN_P VARIABLE DISTINCT INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',230),
  ('while_loop -> WHILE OPEN_P VARIABLE DISTINCT VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',231),
  ('while_loop -> WHILE OPEN_P VARIABLE LESS_EQUAL INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',232),
  ('while_loop -> WHILE OPEN_P VARIABLE LESS_EQUAL VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',233),
  ('while_loop -> WHILE OPEN_P VARIABLE LESS_THAN INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',234),
  ('while_loop -> WHILE OPEN_P VARIABLE LESS_THAN VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',235),
  ('while_loop -> WHILE OPEN_P VARIABLE MORE_EQUAL INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',236),
  ('while_loop -> WHILE OPEN_P VARIABLE MORE_EQUAL VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',237),
  ('while_loop -> WHILE OPEN_P VARIABLE MORE_THAN INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',238),
  ('while_loop -> WHILE OPEN_P VARIABLE MORE_THAN VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',239),
  ('while_loop -> WHILE OPEN_P VARIABLE EQUALS_EQUALS INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',240),
  ('while_loop -> WHILE OPEN_P VARIABLE EQUALS_EQUALS VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',241),
  ('while_loop -> WHILE OPEN_P VARIABLE EQUALS INT CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',242),
  ('while_loop -> WHILE OPEN_P VARIABLE EQUALS VARIABLE CLOSE_P SB1 expression SB2','while_loop',9,'p_while_loop','compiler.py',243),
